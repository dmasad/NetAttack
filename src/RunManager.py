...
class RunManager(object):
    ...
    def __init__(self, attacker, defender, num_iterations, fitness, nmb_nodes):
        ...
        self.G = nx.Graph()
        self.G.add_nodes_from(range(nmb_nodes))
    ...
    def run(self):
        ...
        '''
        self.build_initial_network(self.initialEdges)
    ...
    def calculate_network_metrics_attacker(self):
        '''
    ...
    def calculate_network_metrics_defender(self):
        '''
