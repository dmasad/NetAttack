...
#for i in range(5):
i=1
evolution_manager = EvolutionManager(AttackerAgent, Defender, 20, 23,fitness=fitness_function1, pop_size=100, 
                                     generation_count=1000,offspring=2, mutation_rate=0.2,initial_graph=None,instant_rewire=False,output=True,file_name_appendix="_1",file_path="C:/Users/jschmidt/Dropbox/csss2013CoEv/",attacker_resources=5,defender_resources=8)
