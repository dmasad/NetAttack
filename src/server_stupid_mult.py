...
if __name__ == '__main__':
    ...
    if(i == 1):
        print "running"+str(i)
        evolution_manager = EvolutionManager(AttackerAgent, Defender, nodes,edges,fitness=fitness_function1, pop_size=pop_size, 
                                     generation_count=generation_count,offspring=offspring, mutation_rate=mutation_rate,initial_graph=None,instant_rewire=False,output=True,file_name_appendix=i,file_path="",attacker_resources=3,defender_resources=3,
                                     attacker_strategies=att_strat,defender_strategies=def_strat,double_strategy=False)
    ...
    if(i == 17):
        evolution_manager = EvolutionManager(AttackerAgent, Defender, 100,150,fitness=fitness_function1, pop_size=200, 
                                     generation_count=500,offspring=2, mutation_rate=0.05,initial_graph=None,instant_rewire=False,output=True,file_name_appendix=i,file_path="",attacker_resources=3,defender_resources=5,
    ...
    if(i == 33):
        evolution_manager = EvolutionManager(AttackerAgent, Defender, 100,150,fitness=fitness_function1, pop_size=200, 
                                     generation_count=500,offspring=2, mutation_rate=0.05,initial_graph=None,instant_rewire=False,output=True,file_name_appendix=i,file_path="",attacker_resources=3,defender_resources=7,
                                     attacker_strategies=[RandomAttackStrategy(),DegreeAttackStrategy(),BetweennessAttackStrategy()],defender_strategies=[RandomAttachment()],double_strategy=False)
    ...
    if(i == 49):
        evolution_manager = EvolutionManager(AttackerAgent, Defender, 100,150,fitness=fitness_function1, pop_size=200, 
                                     generation_count=500,offspring=2, mutation_rate=0.05,initial_graph=None,instant_rewire=False,output=True,file_name_appendix=i,file_path="",attacker_resources=3,defender_resources=9,
                                     attacker_strategies=[RandomAttackStrategy(),DegreeAttackStrategy(),BetweennessAttackStrategy()],defender_strategies=[RandomAttachment()],double_strategy=False)
